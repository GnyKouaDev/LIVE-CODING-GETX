...
// APP CONSTANTS
const APP_CODE = "LIVE_CODING";
const APP_NAME = "LIVE CODING";
...
const ACCESS_TOKEN = kDebugMode
    ? "$APP_CODE-USER-ACCESS-TOKEN"
    : "$APP_CODE-USER_ACCESS_TOKEN_PROD";
const USER_INFOS =
    kDebugMode ? "$APP_CODE-USER-INFOS" : "$APP_CODE-USER_INFOS_PROD";
